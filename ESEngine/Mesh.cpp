...
void Mesh::showMeshWiring() {
	addNewShader(ShaderManager::getInstance().getShader("Shaders/GeometryDebugShader.vert", "Shaders/GeometryDebugShader.frag", "Shaders/MeshWiringShader.geom"));
}

void Mesh::showNormalVisualisation() {
	addNewShader(ShaderManager::getInstance().getShader("Shaders/GeometryDebugShader.vert", "Shaders/GeometryDebugShader.frag", "Shaders/NormalVisualisationShader.geom"));
}